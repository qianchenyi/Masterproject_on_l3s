...
class UploadData():
  ...
  def shuffle_nomalize(self, mixdata_set, mal_set, ben_set):
    ...
    def get_train_dataset(self):
        training_set,training_mal_set,training_ben_set = shuffle_nomalize(self.training_set,self.training_mal_set,self.training_ben_set)
    return training_set,training_mal_set,training_ben_set

    def get_vali_dataset(self):
        val_set,val_mal_set,val_ben_set = shuffle_nomalize(self.val_set,self.val_mal_set,self.val_ben_set)
        return val_set,val_mal_set,val_ben_set
    def  get_test_dataset(self):
        test_set,test_mal_set,test_ben_set = shuffle_nomalize(self.test_set,self.test_mal_set,self.test_ben_set)
