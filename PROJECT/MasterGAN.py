    ...
    def train(self,ben_ds, malware_sample,test_mal_path_exes, bb_on_real_):
        ...
        for epoch in range(self.EPOCHS):
            ...
            # Generator training
                ...
                log = '\n gen_loss = {0:.3f}, dis_loss = {1:.3f}, gen_acc = {2:.3f}, dis_acc = {3:.3f}'.format(gen_loss_now, sub_loss, gen_acc_now, sub_acc)
                print(log)
            ...
            np.save('/home/qian/Masterproject/Results/bb_on_adv.npy',np.array(self.bb_on_adv_array))
